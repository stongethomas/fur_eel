class BandsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @band.save
        format.html { redirect_to '/bands/admin', notice: 'Band was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @band.update_attributes(params[:band])
        format.html { redirect_to '/bands/admin', notice: 'Band was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to '/bands/admin' }
      format.json { head :no_content }
    end
  end
end
